...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/wuzhixaun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'wuzhixuano@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/wuzhixaun', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  MOUSE_FOLLOW_EFFECT_TYPE: process.env.NEXT_MOUSE_FOLLOW_EFFECT_TYPE || 11, // 1-12
